...
| Variable name | Required | Default value | Choices | Description
|-
| vsftpd_enable_local_users | No | true | true or false | Enable local users connection
| vsftpd_chroot_local_users	| No | false | true or false | Enable chrooting for local users <br /> **Note** : chrooting users needs the user to be chrooted in a valid (owner and mode) chroot path
